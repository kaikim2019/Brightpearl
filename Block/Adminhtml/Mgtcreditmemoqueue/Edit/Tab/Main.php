...
namespace Bsitc\Brightpearl\Block\Adminhtml\Mgtcreditmemoqueue\Edit\Tab;

/**
 * Mgtcreditmemoqueue edit form main tab
 */
class Main extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $model = $this->_coreRegistry->registry('mgtcreditmemoqueue');
        ...
        $fieldset->addField(
            ...
            [
                'name' => 'cm_id',
                'label' => __('Creditmemo Id'),
                'title' => __('Creditmemo Id'),
        ...
        $fieldset->addField(
            ...
            'text',
            [
                'name' => 'cm_increment_id',
                'label' => __('Creditmemo Increment Id'),
                'title' => __('Creditmemo Increment Id'),
                'disabled' => $isElementDisabled
            ]
        );
        ...
        $fieldset->addField(
            ...
            [
                'name' => 'json',
                'label' => __('Stock Return'),
                'title' => __('Stock Return'),
                'disabled' => $isElementDisabled
            ]
        );
