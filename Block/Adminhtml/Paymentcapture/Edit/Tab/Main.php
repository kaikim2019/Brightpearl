...
namespace Bsitc\Brightpearl\Block\Adminhtml\Paymentcapture\Edit\Tab;

/**
 * Paymentcapture edit form main tab
 */
class Main extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $model = $this->_coreRegistry->registry('paymentcapture');
        ...
        $fieldset->addField(
            ...
            [
                'name' => 'gon_id',
                'label' => __('Good Out Note Id'),
                'title' => __('Good Out Note Id'),
        ...
        $fieldset->addField(
            ...
            'select',
            [
                'label' => __('Payment Capture Status'),
                'title' => __('Payment Capture Status'),
                'name' => 'mgt_payment_status',
