...
namespace Bsitc\Brightpearl\Block\Adminhtml\Bpleadsourcemap\Edit\Tab;

/**
 * Bpleadsourcemap edit form main tab
 */
class Main extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $model = $this->_coreRegistry->registry('bpleadsourcemap');
        ...
        if ($model->getId()) {
         ...
         $fieldset->addField(
             ...
             [
                'name' => 'code',
                'label' => __('Mgt Customer Group'),
                'title' => __('Mgt Customer Group'),
                'required' => true,
                'type' => 'options',
         ...
         $fieldset->addField(
             ...
             [
                'name' => 'bpcode',
                'label' => __('BP Lead Source'),
                'title' => __('BP Lead Source'),
                'type' => 'options',
                'required' => true,
