...
namespace Bsitc\Brightpearl\Block\Adminhtml\Webhooks\Edit\Tab;

/**
 * Webhooks edit form main tab
 */
class Main extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $model = $this->_coreRegistry->registry('webhooks');
        ...
        */
        ...
        $fieldset->addField(
            ...
            [
                'name' => 'uri_template',
                'label' => __('Uri Template'),
                'title' => __('Uri Template'),
                'disabled' => $isElementDisabled
            ]
        );
