...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    /**
     * @var \Bsitc\Brightpearl\Model\tagsFactory
     */
     ...
     * @param \Bsitc\Brightpearl\Model\tagsFactory $tagsFactory
    ...
    public function __construct(
        ...
        \Bsitc\Brightpearl\Model\TagsFactory $TagsFactory,
    ...
    {
        $collection = $this->_tagsFactory->create()->getCollection();
    ...
    protected function _prepareMassaction()
    {
       ...
       /*  $this->setMassactionIdField('id');
        //$this->getMassactionBlock()->setTemplate('Bsitc_Brightpearl::tags/grid/massaction_extended.phtml');
    ...
    /**
     * @param \Bsitc\Brightpearl\Model\tags|\Magento\Framework\Object $row
     * @return string
     */
